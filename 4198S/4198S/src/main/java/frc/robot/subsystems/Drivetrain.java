...
public class Drivetrain extends SubsystemBase {
        ...
        public Drivetrain() {
                ...
                mLeftFront = Mk4iSwerveModuleHelper.createNeo(
                ...
                mRightFront = Mk4iSwerveModuleHelper.createNeo(
                ...
                mLeftRear = Mk4iSwerveModuleHelper.createNeo(
                ...
                mRightRear = Mk4iSwerveModuleHelper.createNeo(
        ...
        public Rotation2d getGyroscopeRotation() {
                ...
                return Rotation2d.fromDegrees(360 - mNavX.getYaw());
        }
        ...
        public void periodic() {
                ...
                mRightFront.set(states[0].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE,
                                states[0].angle.getRadians());
                mRightRear.set(states[1].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE,
                                states[1].angle.getRadians());
                mLeftFront.set(states[2].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE,
                                states[2].angle.getRadians());
                mLeftRear.set(states[3].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE,
